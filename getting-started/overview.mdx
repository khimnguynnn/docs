...
Bất cứ khi nào bạn theo dõi một sự kiện hoặc gửi email cho người dùng, chúng tôi sẽ tự động tạo một liên hệ trong danh bạ của bạn. This contact contains all the information you need, including the user's email address and any [metadata you have added](/working-with-contacts/metadata).
