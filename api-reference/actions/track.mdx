...
api: "POST https://api.mailsparky.com/v1/track"
description: "Theo dõi các sự kiện trong ứng dụng của bạn và gửi chúng đến MailSpark"
---
...
<ParamField body="data" type="object" placeholder={{"project": "MailSparkt"}}>
